...
export const platformIcons = {
  ...
  instagram: (
    <Instagram color="#E1306C" className="bg-[#E1306C10] size-10 p-2 rounded" />
  ),
  tiktok: (
    <Music2 color="#000000" className="bg-[#00000010] size-10 p-2 rounded" />
  ),
  facebook: (
    <Facebook color="#1877F2" className="bg-[#1877F210] size-10 p-2 rounded" />
  ),
  twitter: (
    <Twitter color="#1DA1F2" className="bg-[#1DA1F210] size-10 p-2 rounded" />
  ),
  linkedin: (
    <Linkedin color="#0077B5" className="bg-[#0077B510] size-10 p-2 rounded" />
  ),
  pinterest: (
